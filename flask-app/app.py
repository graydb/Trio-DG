...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://douglasgray@dougiescoolmysql:remembermypassword@dougiescoolmysql.mysql.database.azure.com:3306/flaskdb'
